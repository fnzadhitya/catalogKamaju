...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2024 at 01:54 AM
...
INSERT INTO `tb_customer` (`id_customer`, `nama_customer`, `logo_customer`) VALUES
(1, 'ASMIN BARA BRONANG', 'logo_abb.png'),
(2, 'BHUMI JEPARA SERVICE', 'logo_bjs.png'),
(3, 'BINA PERTIWI', 'logo_bp.png'),
(4, 'BINTANG KALIMANTAN MANDIRI', 'BKM.png'),
(5, 'ENERGIA PRIMA NUSANTARA', 'EPN.png'),
(6, 'KALIMANTAN PRIMA PERSADA', 'logo_kpp.png'),
(7, 'KOMATSU MARKETING AND SUPPORT INDONESIA', 'kmsi.png'),
(8, 'KOMATSU REMANUFACTURING INDONESIA', 'kra1.png'),
(9, 'PAMAPERSADA NUSANTARA', 'pama.png'),
(10, 'PUTRA PERKASA ABADI', 'ppa.png'),
(11, 'SUPRABARI MAPANINDO MINERAL', 'smm.png'),
(12, 'SWADAYA HARAPAN NUSANTARA', 'shn.png'),
(13, 'TELEN ORBIT PRIMA', 'top.png'),
(14, 'TRAKTOR NUSANTARA', 'tn.png'),
(15, 'TRIATRA', 'triatra.png'),
(16, 'UNITED TRACTORS', 'ut.png'),
(17, 'UNITED TRACTORS PANDU ENGINEERING', 'patria-utpe.png');
...
(8, 'ROMPI', '', '', 5, 14, '0pcs', '-', '-', '-', '-'),
(9, 'CHAMBRY', 'CHAMBRE KMJ FRONT (Small).png', 'CHAMBRE KMJ BACK (Small).png', 1, 22, '3', 'Oxford', 'Kamaju', '3cm', 'Biru'),
