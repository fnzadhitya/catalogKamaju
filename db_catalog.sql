...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2023 at 03:14 AM
...
(1, 'SAFETY SHOES', 'SEPATU 2.png', 2, 16, '2', 'Texas', 'Krusher', 'Coklat'),
(2, 'HELMET', 'HELMET_Orange.png', 2, 16, '1', 'V-Gard', 'MSA', 'Orange'),
(3, 'SAFETY GLASS', 'kacamata-removebg-preview.png', 2, 16, '2', 'Angler Clear Leans', 'CIG', 'Bening'),
(4, 'EARPLUG', 'EAR Plug.png', 2, 16, '1pcs', '', '3M Ultrafit', 'Biru Kuning'),
(5, 'SAFETY SHOES', 'SEPATU 2.png', 5, 14, '1pcs', 'Texas', 'Krusher', 'coklat'),
(6, 'HELMET', 'helm_kuning.png', 5, 14, '1pcs', 'V-Gard', 'MSA', 'Kuning'),
(7, 'SAFETY GLASS', 'kacamata-removebg-preview.png', 5, 14, '1', 'Angler Clear Leans', 'CIG', 'Bening'),
(8, 'EARPLUG', 'EARPLUG.png', 5, 14, '1', '', '3M Ultrafit', 'Biru Kuning'),
(9, 'SAFETY SHOES', 'SEPATU 2.png', 1, 22, '1', 'Texas', 'Krusher', 'Coklat'),
(10, 'HELMET', 'helm_kuning.png', 1, 22, '1', 'V-Gard', 'MSA', 'Kuning'),
...
(13, 'SAFETY SHOES', 'SEPATU 2.png', 3, 8, '1', 'Texas', 'Krusher', 'coklat'),
...
(24, 'EARPLUG', 'EARPLUG.png', 3, 10, '1', '', '3M Ultrafit', 'Biru Kuning'),
...
(51, 'SAFETY GLASS', 'kacamata-removebg-preview.png', 6, 32, '1', 'Angler Clear Leans', 'CIG', 'Bening'),
(52, 'EARPLUG', 'EARPLUG.png', 6, 32, '1', '', '3M Ultrafit', 'Biru Kuning'),
...
(67, 'SAFETY GLASS', 'MRT_ProduckIm.png', 9, 23, '2', 'Angler Clear Leans', 'CIG', 'Bening'),
...
(75, 'SAFETY GLASS', 'kacamata-removebg-preview.png', 10, 12, '1', 'Angler Clear Leans', 'CIG', 'Bening'),
...
(106, 'HELMET', 'helm_kuning.png', 16, 4, '0', '', '', ''),
(107, 'SAFETY GLASS', 'kacamata-removebg-preview.png', 16, 4, '0', '', '', ''),
(108, 'EARPLUG', 'EARPLUG.png', 16, 4, '0', '', '', ''),
...
(123, 'SAFETY GLASS', 'kacamata-removebg-preview.png', 16, 13, '1', '', '', ''),
(124, 'EARPLUG', 'EARPLUG.png', 16, 13, '1', '', '', ''),
(125, 'SAFETY SHOES', 'SEPATU 2.png', 16, 30, '1', '', '', ''),
...
(147, 'SAFETY GLASS', 'kacamata-removebg-preview.png', 16, 32, '1', '', '', ''),
(148, 'EARPLUG', 'EARPLUG.png', 16, 32, '1', '', '', ''),
...
--
-- Table structure for table `tb_seragam`
--
...
--
-- Dumping data for table `tb_seragam`
--

INSERT INTO `tb_seragam` (`id_seragam`, `nama_seragam`, `foto1`, `foto2`, `id_customer`, `id_job`, `jumlah`, `bahan`, `logo`, `scotlight`, `warna`) VALUES
(1, 'CHAMBRY', 'bjs_Chambry_front.png', 'bjs-cmbry-back.png', 2, 16, '4', 'Oxford', 'kamaju', '6cm', 'Biru Muda'),
(2, 'KAOS POLO', 'bjs-front.png', 'bjs_back.png', 2, 16, '5', 'Oxford', 'Logo Kamaju', '5cm', 'Biru Muda'),
(3, 'CELANA JEANS', 'jeans_bjs_front.png', 'Jeans_bjs_back.png', 2, 16, '4pcs', '', '', '', 'Biru Dongker'),
(4, 'ROMPI', '', '', 2, 16, '', '', '', '', ''),
(5, 'CHAMBRY', '', '', 5, 14, '', 'Oxford', '', '', 'Biru Muda'),
(6, 'KAOS POLO', 'epn_polo_front.png', 'epn_polo_back.png', 5, 14, '4pcs', 'Baby Terry', 'Kamaju', '5cm', 'Kuning Tua'),
(7, 'CELANA JEANS', 'jeans_front.png', 'jeans_back.png', 5, 14, '3pcs', '', '', '', 'Biru Dongker'),
(8, 'ROMPI', '', '', 5, 14, '', '', '', '', ''),
(9, 'CHAMBRY', 'ABB_CMBRY_FRONT.png', 'ABB_CMBRY_BACK.png', 1, 22, '3pcs', 'Oxford', 'Kamaju', '3cm', 'Biru'),
(10, 'KAOS POLO', 'ABB_POLO_FRONT.png', 'ABB_POLO_BACK.png', 1, 22, '4', 'Baby Terry', 'Kamaju', '3cm', 'Kuning'),
(11, 'CELANA JEANS', 'jeans_front.png', 'jeans_back.png', 1, 22, '4pcs', '', '', '', 'Biru Dongker'),
(12, 'ROMPI', '', '', 1, 22, '', '', '', '', ''),
(13, 'CHAMBRY', 'BP_CMBRY_FRONT.png', 'BP_CMBRY_BACK.png', 3, 8, '2', '', '', '', ''),
(14, 'KAOS POLO', 'BP POLO FRONT .png', 'BP POLO BACK .png', 3, 8, '4pcs', 'Baby Terry', '', '', 'Kuning'),
(15, 'CELANA JEANS', 'CELANA FRONT.png', 'CELANA BACK.png', 3, 8, '4pcs', '', '', '', 'Biru Dongker'),
(16, 'ROMPI', '', '', 3, 8, '', '', '', '', ''),
(17, 'CHAMBRY', '', '', 3, 17, '2', 'Oxford', '', '', ''),
...
(20, 'ROMPI', '', '', 3, 17, '', '', '', '', ''),
(21, 'CHAMBRY', 'BP_CMBRY_FRONT.png', 'BP_CMBRY_BACK.png', 3, 10, '2', 'Oxford', '', '', ''),
(22, 'KAOS POLO', 'HOSE_POLO_FRONT (Small).png', 'HOSE_POLO_ BACK (Small).png', 3, 10, '4', 'Baby Terry', 'HOSE', '', 'Kuning'),
(23, 'CELANA JEANS', 'CELANA FRONT.png', 'CELANA BACK.png', 3, 10, '4pcs', '', '', '', 'Biru Dongker'),
(24, 'ROMPI', '', '', 3, 10, '1pcs', '', '', '', ''),
(25, 'CHAMBRY', '', '', 3, 9, '2pcs', '', '', '', ''),
(26, 'KAOS POLO', '', '', 3, 9, '4pcs', '', '', '', ''),
(27, 'CELANA JEANS', 'CELANA FRONT.png', 'CELANA BACK.png', 3, 9, '4', '', '', '', 'Biru Dongker'),
(28, 'ROMPI', '', '', 3, 9, '1pcs', '', '', '', ''),
(29, 'CHAMBRY', '', '', 3, 25, '2pcs', '', '', '', ''),
(30, 'KAOS POLO', '', '', 3, 25, '2pcs', '', '', '', ''),
(31, 'CELANA JEANS', 'jeans_front.png', 'jeans_back.png', 3, 25, '3', '', '', '', 'Biru Dongker'),
(32, 'ROMPI', '', '', 3, 25, '', '', '', '', ''),
(33, 'CHAMBRY', 'BP_CMBRY_FRONT.png', 'BP_CMBRY_BACK.png', 3, 28, '1', 'Oxford', 'Bina Pertiwi', '', ''),
(34, 'KAOS POLO', 'BP POLO FRONT .png', 'BP POLO BACK .png', 3, 28, '2pcs', 'Baby Terry', 'Bina Pertiwi', '', 'Kuning'),
(35, 'CELANA JEANS', 'jeans_front.png', 'jeans_back.png', 3, 28, '3', '', '', '', 'Biru Dongker'),
(36, 'ROMPI', '', '', 3, 28, '', '', '', '', ''),
(37, 'CHAMBRY', 'BP_CMBRY_FRONT.png', 'BP_CMBRY_BACK.png', 3, 7, '1pcs', 'Oxford', 'Bina Pertiwi', '', ''),
...
(40, 'ROMPI', '', '', 3, 7, '', '', '', '', ''),
(41, 'CHAMBRY', 'CHAMBRE KMJ FRONT (Small).png', 'CHAMBRE KMJ BACK (Small).png', 4, 11, '2', '', '', '', ''),
(42, 'KAOS POLO', 'POLO KMJ FRONT (Small).png', 'POLO KMJ BACK (Small).png', 4, 11, '4', '', '', '', ''),
(43, 'CELANA JEANS', 'CELANA FRONT.png', 'CELANA BACK.png', 4, 11, '4', '', '', '', 'Biru Dongker'),
(44, 'ROMPI', '', '', 4, 11, '', '', '', '', ''),
...
(52, 'ROMPI', '', '', 6, 32, '', '', '', '', ''),
(53, 'CHAMBRY', 'CHAMBRE KMJ FRONT (Small).png', 'CHAMBRE KMJ BACK (Small).png', 6, 11, '2', 'Oxford', 'Kamaju', '5cm', 'Biru Muda'),
...
(60, 'ROMPI', '', '', 7, 24, '', '', '', '', ''),
(61, 'CHAMBRY', 'UT NASIONAL FRONT (Small).png', 'UT NASIONAL BACK (Small).png', 8, 31, '4', 'Oxford', 'UT Nasional,GPS', '5cm', 'Biru Muda'),
...
(66, 'KAOS POLO', 'PAMA POLO FRONT (Small).png', 'PAMA POLO BACK (Small).png', 9, 23, '6', 'Baby Terry', 'Kamaju', '', 'Kuning'),
...
(72, 'ROMPI', 'sunsetkmj.jpg', 'sunsetkmj.jpg', 9, 32, '0', '', '', '', ''),
...
(83, 'CELANA JEANS', 'CELANA FRONT.png', 'CELANA BACK.png', 12, 16, '3', '', '', '', 'Biru Dongker'),
(84, 'ROMPI', '', '', 12, 16, '', '', '', '', ''),
...
(104, 'ROMPI', '', '', 14, 33, '', '', '', '', ''),
(105, 'CHAMBRY', '', '', 16, 4, '3', '', '', '5cm', ''),
(106, 'KAOS POLO', '', '', 16, 4, '4', '', '', '5cm', ''),
(107, 'CELANA JEANS', 'CELANA FRONT.png', 'CELANA BACK.png', 16, 4, '3', '', '', '', 'Biru Dongker'),
(108, 'ROMPI', '', '', 16, 4, '0', '', '', '', ''),
...
(152, 'ROMPI', '', '', 16, 19, '', '', '', '', ''),
(153, 'CHAMBRY', 'UT NASIONAL FRONT (Small).png', 'UT NASIONAL BACK (Small).png', 16, 18, '2', '', '', '5cm', ''),
...
--
-- Constraints for table `tb_seragam`
--
ALTER TABLE `tb_seragam`
