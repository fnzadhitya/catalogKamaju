    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <a href="index.php?page=tambah-data-seragam">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                <td><?php echo $id; ?></td>
                <td><?php echo $ctg['nama_seragam']; ?></td>
                <td>
                  <img src="foto/<?php echo $ctg['foto1']; ?>" width="100px">
                </td>
                <td>
                  <img src="foto/<?php echo $ctg['foto2']; ?>" width="100px">
                </td>
                ...
                <td>
                  <a href="index.php?page=edit-data-seragam&&id=<?php echo $ctg['id_seragam']; ?>" class="btn btn-sm btn-warning">Edit</a>
  ...
  function hapus_data(data_id){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location=("delete/hapus_data_seragam.php?id="+data_id)
      } 
    })
  }
</script> 